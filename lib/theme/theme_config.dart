...
class ThemeConfig {
  static ThemeData createTheme({
    ...
    return ThemeData(
      ...
      inputDecorationTheme: InputDecorationTheme(
        errorStyle: TextStyle(fontFamily: 'Poppins-Medium', color: errorColor),
      ...
      unselectedWidgetColor: ColorConstants.remBlackOverlay,
      textTheme: TextTheme(
  ...
  static ThemeData get lightTheme => createTheme(
      ...
      primaryTextColor: ColorConstants.remBlack,
      secondaryTextColor: ColorConstants.remBlack80,
      overLineTextColor: ColorConstants.remBlack60,
      captionTextColor: ColorConstants.remBlack60,
      accentColor: ColorConstants.remYellow,
      dividerColor: ColorConstants.remBlackOpac,
      buttonBackgroundColor: ColorConstants.remYellow,
      buttonTextColor: ColorConstants.remBlack,
      disabledColor: ColorConstants.remBlackOverlay,
      errorColor: ColorConstants.remError,
      backgroundColor: const Color(0xFFF9F9FA),
      backgroundColorSecondary: ColorConstants.white);

  static ThemeData get darkTheme => createTheme(
        brightness: Brightness.dark,
        scaffoldBackgroundColor: ColorConstants.remBlack,
        backgroundColor: const Color(0xFF232B3A),
        backgroundColorSecondary: ColorConstants.remBlack,
        cardBackgroundColor: ColorConstants.remBlack,
        ...
        accentColor: ColorConstants.remYellow,
        dividerColor: ColorConstants.remBlack60,
        buttonBackgroundColor: ColorConstants.remYellow,
